...
import { ActionIcon, Autocomplete, Group, Header, MediaQuery, useMantineColorScheme } from '@mantine/core'
        ...
        <Header height={64} pr={"md"} pl={{ base: "md", lg: 0 }}>
            <Group h="100%" position='apart'>
                <MediaQuery smallerThan="md" styles={{ display: 'none' }}>
                    <Autocomplete data={[]} placeholder='search for resource...' size="xs" w={250} />
                </MediaQuery>
