...
const UiProvider = ({ children }: PropsWithChildren) => {
    ...
    const [colorScheme, setColorSchema] = useState<ColorScheme>(preferedColorSchema as ColorScheme);
    const theme = useMemo<MantineThemeOverride>(() => ({ colorScheme }), [colorScheme])
